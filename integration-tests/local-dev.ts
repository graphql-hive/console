...
applyEnv({
  ...
  REDIS_HOST: serverEnvVars.REDIS_HOST,
  REDIS_PORT: serverEnvVars.REDIS_PORT,
  REDIS_PASSWORD: serverEnvVars.REDIS_PASSWORD,
  ...
  SCHEMA_VERSION_ORIGIN_CUTOFF: serverEnvVars.SCHEMA_VERSION_ORIGIN_CUTOFF,
});
