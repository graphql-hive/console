...
const tabsListVariants = cva('relative flex items-center', {
  variants: {
    variant: {
      default:
        'bg-neutral-3 text-neutral-10 inline-flex h-10 items-center justify-center rounded-md p-1',
      menu: 'text-neutral-2',
...
const tabsTriggerVariants = cva('cursor-pointer appearance-none! text-sm font-medium transition', {
  variants: {
    variant: {
      default:
        'ring-offset-neutral-2 focus-visible:ring-ring data-[state=active]:bg-neutral-3 data-[state=active]:text-neutral-11 inline-flex items-center justify-center whitespace-nowrap rounded-sm px-3 py-1.5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:opacity-50 data-[state=active]:shadow-sm disabled:cursor-not-allowed active:disabled:pointer-events-none',
...
const tabsContentVariants = cva(
  'ring-offset-neutral-2 focus-visible:ring-ring mt-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2',
  {
    variants: {
      variant: {
        default: 'py-7',
