  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="border-neutral-8 hover:text-warning absolute right-3 top-2 cursor-pointer rounded-md border p-2 opacity-0 data-[hovering=true]:opacity-100 data-[hovering=true]:transition-opacity"
        onClick={async ev => {
