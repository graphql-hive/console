      ...
      <SidebarContext.Provider value={contextValue}>
        <TooltipProvider delayDuration={0}>
          <div
            ...
            className={cn(
              'group/sidebar-wrapper has-data-[variant=inset]:bg-neutral-2 flex min-h-svh w-full',
              className,
            )}
            ref={ref}
            {...props}
  ...
  (
    ...
    if (collapsible === 'none') {
      return (
        <div
          className={cn(
            'bg-neutral-2 text-neutral-11 w-(--sidebar-width) flex h-full flex-col',
            className,
          )}
          ref={ref}
          {...props}
      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            data-mobile="true"
            className="bg-neutral-2 text-neutral-11 w-(--sidebar-width) p-0 [&>button]:hidden"
            style={
              {
    ...
    return (
      ...
      >
        ...
        >
          <div
            data-sidebar="sidebar"
            className="bg-neutral-2 group-data-[variant=floating]:border-neutral-5 flex size-full flex-col group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:shadow-sm"
          >
            {children}
          </div>
        </div>
  ...
  ({ className, ...props }, ref) => {
    ...
    return (
      <button
        ...
        className={cn(
          'hover:after:bg-neutral-5 absolute inset-y-0 z-20 hidden w-4 -translate-x-1/2 transition-all ease-linear after:absolute after:inset-y-0 after:left-1/2 after:w-[2px] group-data-[side=left]:-right-4 group-data-[side=right]:left-0 sm:flex',
          ...
          'group-data-[collapsible=offcanvas]:hover:bg-neutral-2 group-data-[collapsible=offcanvas]:translate-x-0 group-data-[collapsible=offcanvas]:after:left-full',
...
>(({ className, ...props }, ref) => {
  return (
    <Separator
      ...
      className={cn('bg-neutral-5 mx-2 w-auto', className)}
      {...props}
    />
  );
});
...
const sidebarMenuButtonVariants = cva(
  'peer/menu-button flex w-full items-center gap-2 overflow-hidden rounded-md p-2 text-left text-sm outline-none ring-blue transition-[width,height,padding] hover:bg-neutral-5 hover:text-neutral-11 focus-visible:ring-2 active:bg-neutral-5 active:text-neutral-11 disabled:pointer-events-none disabled:opacity-50 group-has-data-[sidebar=menu-action]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-neutral-5 data-[active=true]:font-medium data-[active=true]:text-neutral-11 data-[state=open]:hover:bg-neutral-5 data-[state=open]:hover:text-neutral-11 group-data-[collapsible=icon]:size-8! group-data-[collapsible=icon]:p-2! [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0',
  {
    variants: {
      variant: {
        default: 'hover:bg-neutral-5 hover:text-neutral-11',
        outline:
          'bg-neutral-3 shadow-[0_0_0_1px_hsl(var(--neutral-5))] hover:bg-neutral-5 hover:text-neutral-11 hover:shadow-[0_0_0_1px_hsl(var(--neutral-5))]',
      },
      size: {
        default: 'h-8 text-sm',
        sm: 'h-7 text-xs',
...
const SidebarMenuSub = React.forwardRef<HTMLUListElement, React.ComponentProps<'ul'>>(
  ({ className, ...props }, ref) => (
    <ul
      ...
      className={cn(
        'border-neutral-5 mx-3.5 flex min-w-0 translate-x-px flex-col gap-1 border-l px-2.5 py-0.5',
        'group-data-[collapsible=icon]:hidden',
        className,
      )}
      {...props}
