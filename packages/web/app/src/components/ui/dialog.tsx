  ...
  <DialogPortal>
    ...
    >
      ...
      {hideCloseButton ? null : (
        <DialogPrimitive.Close className="ring-offset-neutral-2 focus:ring-ring data-[state=open]:bg-accent data-[state=open]:text-neutral-10 absolute right-4 top-4 rounded-sm opacity-70 transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:pointer-events-none">
