...
>(({ className, children, hideCloseButton, ...props }, forwardedRef) => {
  // Published so base floating components inside the dialog portal into it rather than to
  // `<body>`, where a modal Radix dialog blocks pointer events.
