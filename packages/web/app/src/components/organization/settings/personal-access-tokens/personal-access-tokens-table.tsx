...
const PersonalAccessTokensTable_OrganizationAccessTokenConnectionFragment = graphql(`
  fragment PersonalAccessTokensTable_OrganizationAccessTokenConnectionFragment on OrganizationAccessTokenConnection {
    edges {
      cursor
      node {
        id
...
type AccessTokensTable = {
  ...
  accessTokens: FragmentType<
    typeof PersonalAccessTokensTable_OrganizationAccessTokenConnectionFragment
  >;
  refetch: () => void;
};
