...
const TARGET_SETTINGS: NavigationItem[] = [
  ...
  },
  {
    id: 'base-schema',
    label: 'Base Schema',
    to: futureRoute('/$organizationSlug/$projectSlug/$targetSlug/settings/base-schema'),
    params: TARGET,
  ...
  },
  {
    ...
    to: futureRoute('/$organizationSlug/$projectSlug/$targetSlug/settings/breaking-changes'),
    params: TARGET,
  ...
  },
  {
    ...
    to: futureRoute('/$organizationSlug/$projectSlug/$targetSlug/settings/schema-contracts'),
    params: TARGET,
  ...
  },
  {
    ...
    to: futureRoute('/$organizationSlug/$projectSlug/$targetSlug/settings/registry-token'),
    params: TARGET,
  ...
  },
  {
    id: 'cdn',
    label: 'CDN Tokens',
    to: futureRoute('/$organizationSlug/$projectSlug/$targetSlug/settings/cdn'),
    params: TARGET,
