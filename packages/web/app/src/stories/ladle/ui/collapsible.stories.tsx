  ...
  return (
    <Collapsible open={isOpen} onOpenChange={setIsOpen} className="w-full max-w-md space-y-2">
      <div className="flex items-center justify-between space-x-4">
        <h4 className="text-neutral-12 text-sm font-semibold">
      ...
      <CollapsibleContent className="space-y-2">
        <div className="text-neutral-11 rounded-md border border-neutral-6 px-4 py-3 text-sm">
...
export const ColorPaletteShowcase: Story = () => {
  ...
  return (
    <div className="space-y-8 p-8 bg-neutral-2 rounded-lg max-w-4xl">
      <div>
        <h2 className="text-neutral-12 text-xl font-bold mb-4">Collapsible Component</h2>
      ...
      <div>
        ...
        <div className="p-4 bg-neutral-1 rounded border border-neutral-6">
          <p className="text-neutral-11 text-sm mb-2">Collapsible (Root):</p>
      ...
      <div>
        <h2 className="text-neutral-12 text-xl font-bold mb-4">Comparison with Accordion</h2>
        <div className="space-y-4">
          <div className="p-4 bg-neutral-1 rounded border border-neutral-6">
          ...
          <div className="p-4 bg-neutral-1 rounded border border-neutral-6">
            <p className="text-neutral-11 text-sm font-medium mb-2">Accordion</p>
            <ul className="text-xs space-y-1 text-neutral-10">
      ...
      <div>
        ...
        <div className="space-y-4">
          <div className="p-4 bg-neutral-1 rounded border border-neutral-6">
            <p className="text-neutral-11 text-sm font-medium mb-2">Show/Hide Details</p>
            <p className="text-neutral-10 text-xs">
              Expand to show additional information, settings, or options.
            </p>
          </div>
          <div className="p-4 bg-neutral-1 rounded border border-neutral-6">
            <p className="text-neutral-11 text-sm font-medium mb-2">Advanced Options</p>
            <p className="text-neutral-10 text-xs">
              Hide advanced settings by default, show on demand.
            </p>
          </div>
          <div className="p-4 bg-neutral-1 rounded border border-neutral-6">
            <p className="text-neutral-11 text-sm font-medium mb-2">Sidebar Sections</p>
            <p className="text-neutral-10 text-xs">
