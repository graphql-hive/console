  ...
  it('registers exactly these routes', { timeout: 30_000 }, async () => {
    ...
    expect(Object.keys(router.routesById).sort()).toMatchInlineSnapshot(`
      [
        ...
        /authenticated/$organizationSlug/$projectSlug/$targetSlug/alerts/with-nav/,
        /authenticated/$organizationSlug/$projectSlug/$targetSlug/alerts/with-nav/create,
        /authenticated/$organizationSlug/$projectSlug/$targetSlug/alerts/with-nav/rules,
        ...
        /authenticated/$organizationSlug/$projectSlug/$targetSlug/settings/,
        /authenticated/$organizationSlug/$projectSlug/$targetSlug/settings/base-schema,
        /authenticated/$organizationSlug/$projectSlug/$targetSlug/settings/breaking-changes,
        /authenticated/$organizationSlug/$projectSlug/$targetSlug/settings/cdn,
        /authenticated/$organizationSlug/$projectSlug/$targetSlug/settings/registry-token,
        /authenticated/$organizationSlug/$projectSlug/$targetSlug/settings/schema-contracts,
        ...
        /authenticated/$organizationSlug/$projectSlug/view/settings/,
        /authenticated/$organizationSlug/$projectSlug/view/settings/access-tokens,
        /authenticated/$organizationSlug/$projectSlug/view/settings/composition,
        /authenticated/$organizationSlug/$projectSlug/view/settings/policy,
        ...
        /authenticated/$organizationSlug/view/members/,
        /authenticated/$organizationSlug/view/members/groups,
        /authenticated/$organizationSlug/view/members/invitations,
        /authenticated/$organizationSlug/view/members/roles,
        /authenticated/$organizationSlug/view/settings,
        /authenticated/$organizationSlug/view/settings/,
        /authenticated/$organizationSlug/view/settings/access-tokens,
        /authenticated/$organizationSlug/view/settings/personal-access-tokens,
        /authenticated/$organizationSlug/view/settings/policy,
        /authenticated/$organizationSlug/view/settings/sso,
