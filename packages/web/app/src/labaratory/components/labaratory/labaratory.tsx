...
import { Collections } from '@/labaratory/components/labaratory/collections';
import { Command } from '@/labaratory/components/labaratory/command';
import {
  LabaratoryPermission,
  LabaratoryPermissions,
  LabaratoryProvider,
  useLabaratory,
  type LabaratoryApi,
} from '@/labaratory/components/labaratory/context';
import { Env } from '@/labaratory/components/labaratory/env';
import { History } from '@/labaratory/components/labaratory/history';
import { HistoryItem } from '@/labaratory/components/labaratory/history-item';
import { Operation } from '@/labaratory/components/labaratory/operation';
import { Preflight } from '@/labaratory/components/labaratory/preflight';
import { Settings } from '@/labaratory/components/labaratory/settings';
import { Tabs } from '@/labaratory/components/labaratory/tabs';
...
import {
  ...
  DialogHeader,
  DialogTitle,
} from '@/labaratory/components/ui/dialog';
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuGroup,
  ...
  DropdownMenuTrigger,
} from '@/labaratory/components/ui/dropdown-menu';
import {
  Empty,
  EmptyContent,
  EmptyDescription,
...
import { Field, FieldError, FieldGroup, FieldLabel } from '@/labaratory/components/ui/field';
import { Input } from '@/labaratory/components/ui/input';
import {
  ResizableHandle,
  ResizablePanel,
  ResizablePanelGroup,
} from '@/labaratory/components/ui/resizable';
import { Toaster } from '@/labaratory/components/ui/sonner';
import { Tooltip, TooltipContent, TooltipTrigger } from '@/labaratory/components/ui/tooltip';
import { useCollections } from '@/labaratory/lib/collections';
import { useEndpoint } from '@/labaratory/lib/endpoint';
import { useEnv } from '@/labaratory/lib/env';
import { useHistory } from '@/labaratory/lib/history';
import { useOperations } from '@/labaratory/lib/operations';
import { usePreflight } from '@/labaratory/lib/preflight';
import { useSettings } from '@/labaratory/lib/settings';
import { useTabs } from '@/labaratory/lib/tabs';
import { useTests } from '@/labaratory/lib/tests';
...
export const Labaratory = (
  ...
  const checkPermissions = useCallback(
    (
      ...
      return (
        props.permissions?.[namespace as keyof LabaratoryPermissions]?.[
          action as keyof LabaratoryPermission
        ] ?? true
      );
    },
    [props.permissions],
  ...
  return (
    <div className="hive-labaratory size-full" ref={containerRef}>
      ...
      <Dialog open={isUpdateEndpointDialogOpen} onOpenChange={setIsUpdateEndpointDialogOpen}>
        <DialogContent className="sm:max-w-[425px]">
          <DialogHeader>
            ...
            <DialogDescription>Update the endpoint of your labaratory.</DialogDescription>
          </DialogHeader>
      ...
      <Dialog open={isAddTestDialogOpen} onOpenChange={setIsAddTestDialogOpen}>
        <DialogContent className="sm:max-w-[425px]">
          <DialogHeader>
            ...
            <DialogDescription>Add a new test to your labaratory.</DialogDescription>
          </DialogHeader>
          <div className="grid gap-4">
            <form
              id="add-test-form"
