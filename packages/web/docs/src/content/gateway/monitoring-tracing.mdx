...
```bash
hive-gateway supergraph --opentelemetry "http://localhost:4318"
```
...
```bash
hive-gateway supergraph --opentelemetry "http://localhost:4317" --opentelemetry-exporter-type otlp-grpc
```
