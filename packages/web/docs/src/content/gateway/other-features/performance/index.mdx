...
Upstash is a serverless Redis service that provides a fully managed Redis database. You can use
Upstash Redis as a cache storage for your Hive Gateway.
[Learn more about Upstash Redis](https://upstash.com/docs/redis/overall/getstarted)
