...
image, our Node base image is affected by some CVE.

None of those CVE are affecting directly Hive Gateway software, since it doesn't uses any of the
...
If you need a CVE free docker image, we recommend building your own image minimal image that exactly
matches your needs.
