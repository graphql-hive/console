...
| `<hive_cdn_endpoint>`       | The endpoint of your Hive target                                       |
| `<hive_cdn_access_key>`     | The Hive CDN access key                                                |
| `<hive_usage_target>`       | The Hive registry token for usage reporting                            |
| `<hive_usage_access_token>` | The Hive registry target to which the usage data should be reported to |
