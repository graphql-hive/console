...
Hive provides two predefined roles for convenience.

Alternatively, organization owners or members with specific permissions can create and/or assign
custom roles tailored to your teams workflows.
...
Organization owners always have full access to everything within an organization and cannot be
assigned a role.
