...
#### Use Cases for Plugin Implementation

Those hooks provide a lot of flexibility to implement various kinds of plugins. Here are some
example use cases and how you can implement them using the hooks mentioned above.
...
response. Then the router will skip all further processing and return this response to the client.
