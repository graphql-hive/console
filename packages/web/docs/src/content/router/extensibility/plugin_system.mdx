...
Hive Router is using the [`tracing` Crate](https://docs.rs/tracing/latest/tracing/) for it collecting, processing and exporting OpenTelemetry trace information.
