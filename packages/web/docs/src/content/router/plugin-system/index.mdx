...
plugin, please refer to [Extending the Router guide](/docs/router/guides/extending-the-router).
...
The [`on_plugin_init`](/docs/router/plugin-system/hooks#on_plugin_init) hook provides access to the plugin's configuration.
...
Refer to the [Plugin System Hooks page for the complete API and usage examples of each hook](/docs/router/plugin-system/hooks)
...
- [Getting Started Guide](/docs/router/guides/extending-the-router)
- [Plugin Hooks](/docs/router/plugin-system/hooks)
- [Plugin Execution and Lifecycle](/docs/router/plugin-system/execution-and-lifecycle)
