...
The [`on_plugin_init`](/docs/router/plugin-system/hooks#on_plugin_init) hook provides access to the
...
Refer to the
[Plugin System Hooks page for the complete API and usage examples of each hook](/docs/router/plugin-system/hooks)
