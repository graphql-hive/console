...
- `service`: **(string, required)** The AWS service name (e.g., `lambda`, `s3`, etc.).
...
- Shared Credentials File: Typically located at `~/.aws/credentials`
- EC2 Instance Profile Credentials: If running on an AWS EC2 instance with an assigned IAM role
