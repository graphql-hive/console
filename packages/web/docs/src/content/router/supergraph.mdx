...
To run Hive Router, you'll need a Supergraph and the subgraphs running (see [Probes](./observability/probes) page for additional information about Router health state and the relation to the Supergraph).
...
In cases when the Supergraph reload process fails, Hive Router will continue to serve requests from the previous version of the Supergraph and will not impact the performance of the router (see [Probes](./observability/probes) to understand how the Supergraph reload process impacts the router).
