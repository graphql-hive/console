...
In addition, you may specify `retry_policy` and `timeout` configurations to customize the behaviour of the HTTP request to the CDN:

```yaml {5-7} filename="router.config.yaml"
supergraph:
  source: hive
  endpoint: https://cdn.graphql-hive.com/artifacts/v1/... # Use your Hive CDN endpoint here
  key: hvABCD # Use your Hive CDN API key here
