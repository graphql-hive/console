...
- `HIVE_TARGET`: Hive Console target where usage will be reported to
- `HIVE_ACCESS_TOKEN` or `HIVE_USAGE_ACCESS_TOKEN`: The access token to push usage data to Hive
  Console
