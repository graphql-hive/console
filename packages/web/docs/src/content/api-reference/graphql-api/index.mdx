...
Interact programmatically with your Hive Organization via the public Hive Console GraphQL
...
property is non-null and contains the mutation result, while the `error` property is `null`. In
