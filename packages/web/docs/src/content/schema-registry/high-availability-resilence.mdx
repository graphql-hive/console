...
- **Primary CDN (`https://cdn.graphql-hive.com`):** Built on Cloudflare's global network, this is the main endpoint for all CDN traffic.
- **Secondary CDN (`https://cdn-mirror.graphql-hive.com`):** A full replica of the primary CDN, running on AWS CloudFront. It serves as a fallback in the event of a partial or full Cloudflare outage.
...
## Mitigating Outages: Gateway and SDK Configuration
