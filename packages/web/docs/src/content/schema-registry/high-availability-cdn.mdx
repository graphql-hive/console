...
For more on configuring your Gateway and SDKs for high availability, see [Running with Hive Console in Production](/docs/schema-registry/high-availability-resilience).
```mermaid
