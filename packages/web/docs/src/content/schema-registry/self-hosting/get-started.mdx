...
<Callout>
  **Self-hosting Hive Console** does currently not support all of the features as the hosted version.
...
```sh
curl -O https://raw.githubusercontent.com/graphql-hive/console/hive@10.1.0/docker/docker-compose.community.yml
```
...
```sh
wget https://raw.githubusercontent.com/graphql-hive/console/hive@10.1.0/docker/docker-compose.community.yml
```
...
export DOCKER_TAG=":10.1.0" # Pin this to an exact version
