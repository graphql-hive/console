...
```sh
curl -O https://raw.githubusercontent.com/graphql-hive/console/hive@10.2.0/docker/docker-compose.community.yml
```
...
```sh
wget https://raw.githubusercontent.com/graphql-hive/console/hive@10.2.0/docker/docker-compose.community.yml
```
...
export DOCKER_TAG=":10.2.0" # Pin this to an exact version
