...
Hive Gateway is a GraphQL router that can act as a GraphQL Federation gateway, a subgraph or a proxy
gateway for any GraphQL API service.

To get started with your own instance of Hive Gateway, navigate to the the Gateway documentation.
...
It works seamlessly in all JavaScript environments, including Node.js, browsers, and serverless
platforms.
