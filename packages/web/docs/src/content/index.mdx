...
**Hive** is a **MIT open-source** GraphQL platform for managing, collaborating on, and serving all
your GraphQL projects. Hive is fully compatible with [**GraphQL Federation**](/federation),
**Monolithic**, or [**Schema Stitching**](https://the-guild.dev/graphql/stitching) projects.

Our best in class tools give what you need so that you can gain insights, make decisions, and evolve
your GraphQL API with confidence.

- Track the evolution of your GraphQL schema
- Analytics and Observability on how your GraphQL API is being used
- Prevent schema changes that break clients based on real-world traffic
- Notify teams with alerts and notifications
- Enforce schema design best practices
- Secure your GraphQL API with the Hive Gateway

## Hive Console

Hive Console is our [schema registry](/docs/schema-registry). To get started with Hive Console, you
can choose between using our hosted version or opt to self-host if your company does not allow cloud
solutions. For most cases, the hosted solution is significantly simpler and very affordable. See
...
<Cards>
  <Cards.Card
    ...
    title="Hosted"
    href="/docs/schema-registry/get-started/first-steps"
  />
  <Cards.Card arrow title="Self-Hosted" href="/docs/schema-registry/self-hosting/get-started" />
</Cards>

## Hive Gateway

Hive Gateway is a GraphQL router that can act as a GraphQL Federation gateway, a subgraph, or a
proxy gateway -- making it suitable for any GraphQL API. It can be ran as a Docker image, binary, or
JavaScript package with minimal configuration, or
[customized](/docs/gateway/other-features/custom-plugins) to meet your needs.

<Cards>
  <Cards.Card arrow title="Get Started" href="/docs/gateway" />
</Cards>

## Hive Logger

Hive Logger is a lightweight and customizable logging utility designed for use within the GraphQL
Hive ecosystem. It works seamlessly in all JavaScript environments, including Node.js, browsers, and
serverless platforms.

<Cards>
  <Cards.Card arrow title="Improve Your Logs" href="/docs/logger" />
</Cards>
