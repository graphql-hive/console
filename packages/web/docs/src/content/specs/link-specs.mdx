---
title: 'Hive Specs: Federated Features'
---
...
Metadata can be useful for indicating ownership, contact information, importance, domain, or more. It can be viewed in Hive:

import explorerMetadataViewImage from '../../../public/docs/pages/specs/link-specs/explorer_metadata-view.png'
...
And can be used to filter in Hive:

import explorerMetadataFilterImage from '../../../public/docs/pages/specs/link-specs/explorer_metadata-filter.png'
