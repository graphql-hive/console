...
If you already have a Node.js project with a graphql schema that's great you can skip over the next
...
Make sure you get an output specifying the installed version for your CLI.
