...
- Is customising the supergraph possible?
  ...
  Changing the supergraph and adjusting it to your needs, either to accomodate extra fields or allow
  for gradual migration from non-federated systems, is easily achievable using
