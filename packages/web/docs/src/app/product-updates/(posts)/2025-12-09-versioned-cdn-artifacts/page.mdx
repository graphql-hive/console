...
```bash
# Fetch artifact for a specific version
...
```bash copy=false filename="Example response headers"
...
- [Learn more about the High-Availability CDN](/docs/high-availability-cdn)
