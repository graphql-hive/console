...
description:
  Hive Router v0.0.40 introduces a plugin system that lets you extend and customize the router
  using native Rust plugins.
date: 2026-03-05
authors: [arda, dotan]
---
...
impl RouterPlugin for MyPlugin {
    ...
    // Add hooks here. For example, inspect every incoming HTTP request:
    // async fn on_http_request(&self, payload: &mut HttpRequestPayload) { ... }
}
```
