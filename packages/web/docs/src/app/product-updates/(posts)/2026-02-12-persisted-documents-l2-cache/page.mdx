...
- Apollo Server automatically uses server's [cache backend](https://www.apollographql.com/docs/apollo-server/performance/cache-backends) as the L2 cache when available.
