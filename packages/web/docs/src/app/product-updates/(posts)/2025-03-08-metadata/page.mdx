---
title: Subgraph Metadata Per Field
description:
...
[Learn more in the updated documentation](/docs/specs/link-specifications#subgraph-schema-additions)
