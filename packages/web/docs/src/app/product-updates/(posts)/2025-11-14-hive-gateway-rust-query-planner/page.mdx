...
While the Rust Query Planner delivers incredible speed, it currently doesn't support all Hive
Gateway features. We're hard at work to achieve full compatibility soon! Check out the
