...
The following results benchmark the scenario runing 4 subgraphs and a GraphQL gateway with
Federation spec, and runs a heavy query. It's being executed with a constant amount of VUs over a
...
_[See the full benchmark results.](https://github.com/graphql-hive/graphql-gateways-benchmark/blob/main/constant-vus-over-time_result.md)_
