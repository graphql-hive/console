...
![](./graphql-hive-and-clickhouse/data-pipeline.png 'An overview of the architecture')$2
...
![](./graphql-hive-and-clickhouse/data-collecting-part.png 'Data collecting part')$2
...
![](./graphql-hive-and-clickhouse/data-processing-part.png 'Data processing part')$2
...
![](./graphql-hive-and-clickhouse/tables.png 'An overview of our ClickHouse tables')$2
...
![](./graphql-hive-and-clickhouse/date-ranges.png 'Operations page and the date range filter')$2
...
![](./graphql-hive-and-clickhouse/clients.png 'Operations page and the Clients section')$2
...
![](./graphql-hive-and-clickhouse/async-sync-inserts.png 'Difference between synchronous and asynchronous inserts in ClickHouse')$2
