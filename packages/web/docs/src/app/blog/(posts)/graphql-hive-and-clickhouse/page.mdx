...
![](./graphql-hive-and-clickhouse/data-pipeline.png 'An overview of the architecture')
...
![](./graphql-hive-and-clickhouse/data-collecting-part.png 'Data collecting part')
...
![](./graphql-hive-and-clickhouse/data-processing-part.png 'Data processing part')
...
![](./graphql-hive-and-clickhouse/tables.png 'An overview of our ClickHouse tables')
...
![](./graphql-hive-and-clickhouse/date-ranges.png 'Operations page and the date range filter')
...
![](./graphql-hive-and-clickhouse/clients.png 'Operations page and the Clients section')
...
![](./graphql-hive-and-clickhouse/async-sync-inserts.png 'Difference between synchronous and asynchronous inserts in ClickHouse')
