...
<Callout type="success" emoji="🚀">
  ...
  open-source GraphQL federation gateway. In independent benchmarks, Hive Router outperforms other
  leading gateways across RPS, latency, and resource usage. 👉 See the [benchmark
  results](https://the-guild.dev/graphql/hive/federation-gateway-performance).
</Callout>
