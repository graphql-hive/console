...
<Callout type="info" emoji="📊">
  Prefer numbers? See the live, reproducible benchmark (RPS, p95/p99, CPU, memory):
  <a href="https://the-guild.dev/graphql/hive/federation-gateway-performance">GraphQL Gateway Performance Benchmarks</a>.
</Callout>
