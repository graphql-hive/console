...
image: ./fadbe31be89eb8b0be9fc5f035c9617d.png
---
...
![](./fadbe31be89eb8b0be9fc5f035c9617d.png 'Analyzing the JSX code.')

And to put things simple, here's a schematic representation of the analysis above:

![](./7c7f8978be94efed4206593bbf067568.png 'A schematic representation of the analysis.')
...
![](./55cc9640bbaec3a7b9a5948d71adfd3a.png 'Node type schemas.')
...
![](./7ba5847a0000df3ef06a6913a79346f2.png 'Any time we parse a small part of the string, we slice
the part we've just parsed.')
