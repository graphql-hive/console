...
![Schema Checks Overview](./schema-checks.png)$2
...
![Schema Coordinate Client Usage on Explorer Page](./schema-coordinate-client-usage.png)$2
...
![Subgraph Information on Explorer](./subgraph.png)$2
...
![Filter Operations by Client](./hive-summer-update-2023/filter-by-client.png)$2
...
![New documentation search](./hive-summer-update-2023/docs-search.png)
