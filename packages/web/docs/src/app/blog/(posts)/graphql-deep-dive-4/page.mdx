...
![GraphQL Modules Directory Structure](./1.png)$2
...
![GraphQL Tools operations](./6.png)$2

And it also helps me write my own directives like this:

![GraphQL Directives](./7.png)$2
...
![GraphQL Gateway](./graphql-deep-dive-4/8.png)
...
![Typed Document Node Example](./9.png)$2
