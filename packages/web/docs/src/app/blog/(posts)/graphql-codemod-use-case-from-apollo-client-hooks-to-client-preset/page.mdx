---
title: GraphQL Codemod Use Case - Migrating from Generated Apollo Client Hooks to Client Preset
description:
...
time. However, we lose these types by using the generated Apollo Client hooks. Client Preset was
created to solve this issue (and the bloated bundle size caused by the generated hooks), so it
remains our recommended approach to write GraphQL operations.
...
In this blog post, we explored how to use GraphQL codemod to migrate from generated Apollo Client
