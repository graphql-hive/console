...
GraphQL Code Generator has just gone through a major update to improve type correctness and
usability for both Federation and normal GraphQL server architecture. This is a big milestone for
us, which closes many long-standing reported issues and serves as the foundation to help us move
faster.
...
This GraphQL Codegen major version update comes with improved support for Federation and normal use
cases for type correctness based on community feedback and collaboration. It also overhauls old
config and internal implementation to improve contributor's Developer Experience.
