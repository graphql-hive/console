...
We're excited to announce Hive Gateway v2 – a major release that addresses the real pain points
...
### 🔍 OpenTelemetry That Actually Works
...
- Incomplete or missing spans that left gaps in your traces
- Poor span parenting that made it impossible to understand request flow
- SDK version conflicts that forced you to choose between observability and stability
- Limited customization that didn't fit your monitoring setup
...
### 📊 Structured Logging with Request-Level Observability
...
### 🚀 Event-Driven Federation Subscriptions
...
12-core processor, spawning 12 Node.js workers isn't optimal – it's usually slower due to:
...
**[Read more about the disabled automatic fork →](/docs/migration-guides/gateway-v1-v2#disabled-automatic-forking)**
...
explicitly enable them – but we recommend dedicated file upload services instead.
