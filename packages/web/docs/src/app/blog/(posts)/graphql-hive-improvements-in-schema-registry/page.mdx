...
thumbnail: ./graphql-hive/improvements-in-schema-registry/thumbnail.png
---
...
![](./graphql-hive/improvements-in-schema-registry/upgrade-project-sample.png 'A preview of the "Upgrade Project" section in settings')
