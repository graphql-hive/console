...
![Mesh SDK](./graphql-mesh/sdk.png 'Mesh SDK')
...
![Pipeline Architecture](./graphql-mesh/pipeline-architecture.png 'Pipeline Architecture')
...
![Libraries](./graphql-mesh/libraries.png 'Libraries')
...
![Any](./graphql-mesh/img-1.png 'Any')
...
![No Any](./graphql-mesh/img-2.png 'No Any')
...
![GraphQL Mesh as an SDK running inside the services](./graphql-mesh/gateway-1.png 'GraphQL Mesh as an SDK running inside the services')
...
![GraphQL Mesh as a self hosted gateway](./graphql-mesh/gateway-2.png 'GraphQL Mesh as a self hosted gateway')
