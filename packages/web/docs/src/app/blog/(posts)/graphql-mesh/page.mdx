...
![Mesh SDK](./graphql-mesh/sdk.png 'Mesh SDK')$2
...
![Pipeline Architecture](./graphql-mesh/pipeline-architecture.png 'Pipeline Architecture')$2
...
![Libraries](./graphql-mesh/libraries.png 'Libraries')$2
...
![Any](./graphql-mesh/img-1.png 'Any')$2
...
![No Any](./graphql-mesh/img-2.png 'No Any')$2
...
![GraphQL Mesh as an SDK running inside the services](./graphql-mesh/gateway-1.png 'GraphQL Mesh as an SDK running inside the services')$2
...
![GraphQL Mesh as a self hosted gateway](./graphql-mesh/gateway-2.png 'GraphQL Mesh as a self hosted gateway')$2
