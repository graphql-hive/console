...
Again we start with user stories, but instead of a building our database next, build the UI/UX that
meets the requirements. Then, based on proximity and hierarchy, extract types and fields to build
your entities.
...
Ignoring pagination to keep this simple, we can see that this UI as some very clear requirements.
...
every day without realising. One of these concepts is that of a “bounded context”.
...
for which you're responsibile supplying paper. But "territory" carries different meaning to the
...
This example diagram shows a number of bounded contexts. Each the nodes on in this diagram is itself
also a bounded context... and there’s yet another surrounding everything. This seems complicated and
it is, but the human brain is very good figuring out the right context.
...
- DDD makes sense if your API serves multiple, distinct clients because it let’s you map your
...
- If you have a large team, then DDD has the added benefit of letting you define your entities up
  ...
  agree on a contract up front of the structures and functionality. Using these practices lets
...
approach not covered here. Whatever you do, don’t be afraid of mistakes and let your schema evolve
your schema over time.
