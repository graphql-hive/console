...
thumbnail: ./announcing-graphql-hive/thumbnail.png
---
...
![Schema checks on CI](./announcing-graphql-hive/schema-checks-gh.png)
...
![Schema checks conditional breaking changes configuration](./announcing-graphql-hive/schema-checks-conditional-configuration.png)
...
![Hive changes history page](./announcing-graphql-hive/changes-history.png)
...
![Hive monitoring dashboard](./announcing-graphql-hive/monitoring-preview.png)
...
![Schema checks Slack message](./announcing-graphql-hive/slack-schema-change.png)
