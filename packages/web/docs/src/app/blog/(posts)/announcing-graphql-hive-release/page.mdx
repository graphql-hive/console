...
image: ./announcing-graphql-hive/cover.png
thumbnail: ./announcing-graphql-hive/thumbnail.png$2
---
...
![Schema checks on CI](./announcing-graphql-hive/schema-checks-gh.png)$2
...
![Schema checks conditional breaking changes configuration](./announcing-graphql-hive/schema-checks-conditional-configuration.png)$2
...
![Hive changes history page](./announcing-graphql-hive/changes-history.png)$2
...
![Hive monitoring dashboard](./announcing-graphql-hive/monitoring-preview.png)$2
...
![Schema checks Slack message](./announcing-graphql-hive/slack-schema-change.png)$2
