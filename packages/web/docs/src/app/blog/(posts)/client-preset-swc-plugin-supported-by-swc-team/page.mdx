...
[SWC plugin](https://www.npmjs.com/package/@graphql-codegen/client-preset-swc-plugin) is now officially part of the
[swc-project/plugins](https://github.com/swc-project/plugins/tree/main/contrib/graphql-codegen-client-preset) repo - maintained and supported by the SWC team!
