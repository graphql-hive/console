...
When serving your contract you deploy the Gateway that consumes the schema contract from the schema
registry to your infrastructure.
...
As a additional measure you can leverage persisted documents to avoid execution of arbitary GraphQL
operations against the private schema.
