...
![StackOverflow Answer](./graphql-modules-auth/stackoverflow-answer.png 'StackOverflow Answer')
...
![Where to put your authentication?](./graphql-modules-auth/where-to-put-graph.png 'Where to put your authentication?')
...
![GraphQL Modules](./graphql-modules-auth/graphql-modules.png 'GraphQL Modules')
