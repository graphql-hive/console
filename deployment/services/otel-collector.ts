...
export function deployOTELCollector(args: {
  ...
  return new ServiceDeployment(
    'otel-collector',
    {
      ...
      startupProbe: '/',
      exposesMetrics: true,
      replicas: args.environment.resources.tracingCollector.maxReplicas,
      pdb: true,
      availabilityOnEveryNode: true,
      port: 4318,
      memoryLimit: args.environment.resources.tracingCollector.memoryLimit,
      autoScaling: {
        maxReplicas: args.environment.resources.tracingCollector.maxReplicas,
        cpu: {
          limit: args.environment.resources.tracingCollector.cpuLimit,
